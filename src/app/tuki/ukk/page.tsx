				...
				faqs: [
					{
						...
						a: "Kyllä, toimitus on ilmainen Suomessa.",
					},
					{
						q: "Milloin tilaus lähetetään?",
						a: "Lähetämme tilaukset viimeistään seuraavana arkipäivänä.",
					},
					{
						q: "Saanko seurantakoodin?",
						a: "Kyllä. Saat seurantakoodin sähköpostitse, kun paketti on matkalla.",
					},
				],
			},
			{
				...
				faqs: [
					{
						q: "Mikä on takuuaika?",
						a: "12 kuukautta kaikille tuotteille. Lisätiedot sivulla /takuu.",
					},
					{
						q: "Voinko palauttaa tuotteen?",
						a: "Kyllä. 14 päivän palautusoikeus alkuperäisessä kunnossa ja pakkauksessa.",
					},
					{
						q: "Miten teen takuupyynnön?",
						a: "Ota yhteyttä sivun /yhteystiedot kautta – ohjaamme vianmäärityksessä ja palautuksessa.",
					},
				],
			},
			{
				...
				faqs: [
					{
						q: "Onko Windows asennettu?",
						a: "Kyllä, koneissa on Windows ja ajurit valmiina.",
					},
					{
						q: "Mitä paketissa tulee?",
						a: "Tietokone, virtajohto ja tarvittavat kaapelit. Mahdolliset lisävarusteet on mainittu tuotesivulla.",
					},
				],
			},
			{
				...
				faqs: [
					{
						q: "Mistä näen suorituskyvyn?",
						a: "Tuotesivuilla on arvioitu FPS ja komponenttitiedot.",
					},
					{
						q: "Voinko päivittää osia?",
						a: "Kyllä, useimmat koneet ovat päivitettävissä. Kysy tarvittaessa neuvoa asiakastuesta.",
					},
				],
			},
			{
				...
				faqs: [
					{
						q: "Mistä saan apua?",
						a: "Katso /tuki/ohjeet ja ota yhteyttä /yhteystiedot – vastaamme mahdollisimman pian.",
					},
					{
						q: "Voinko saada neuvontaa ostoon?",
						a: "Kyllä. Autamme valitsemaan sopivan kokoonpanon tarpeisiisi.",
					},
				],
			},
		],
		...
		<main className="min-h-screen bg-[var(--color-surface-1)] text-[var(--color-text-primary)]">
			<section className="mx-auto max-w-5xl px-container py-section">
				<header className="text-center space-y-4 mb-6">
					<h1 className="text-4xl-fluid font-extrabold">
