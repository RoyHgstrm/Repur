...
export default function SupportPage() {
	const supportCards = [
		{
			Icon: MessageCircle,
			title: "UKK",
			desc: "Vastaukset yleisimpiin kysymyksiin",
			href: "/tuki/ukk",
		},
		{
			Icon: Mail,
			title: "Sähköpostituki",
			desc: "asiakaspalvelu@repur.fi",
			href: "mailto:asiakaspalvelu@repur.fi",
		},
		{
			Icon: BookOpenText,
			title: "Ohjeet",
			desc: "Käyttö- ja asennusohjeet",
			href: "/tuki/ohjeet",
		},
	];
	...
	const faqs = [
		{
			q: "Mikä takuu koneilla on?",
			a: "Kaikilla koneilla on 12 kuukauden takuu. Katso tarkemmat takuu- ja palautusehdot sivulta /takuu.",
		},
		{
			q: "Miten teen takuupyynnön?",
			a: "Täytä tukipyyntö sivulla /tuki tai ota yhteyttä sivun /yhteystiedot kautta – autamme ohjein ja palautuksissa.",
		},
		{
			q: "Milloin tilaus lähetetään?",
			a: "Lähetämme viimeistään seuraavana arkipäivänä. Toimitus on ilmainen.",
		},
	];
			...
			<section className="mx-auto max-w-7xl px-container py-12">
				<header className="text-center space-y-4 mb-8">
					...
					<p className="text-lg-fluid text-secondary max-w-2xl mx-auto">
						Nopea apu tilauksiin, takuuseen ja teknisiin kysymyksiin.
					</p>
				</header>
				...
				<Card className="bg-surface-2 border-[var(--color-border-light)] mb-10">
					<CardHeader>
						<CardTitle className="text-xl-fluid">
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
					<Card className="bg-surface-2 border-[var(--color-border-light)]">
						<CardContent className="p-6 flex items-start gap-3">
							...
							<div>
								<p className="text-sm">
									Takuuasiat ja ohjeet löytyvät selkeästi koottuna.
								</p>
								<div className="mt-2">
									<Link href="/takuu">
										<Button className="h-10 px-5">Takuu</Button>
									</Link>
								</div>
							</div>
						</CardContent>
					...
					<Card className="bg-surface-2 border-[var(--color-border-light)]">
						<CardContent className="p-6 flex items-start gap-3">
							...
							<div>
								<p className="text-sm">
									Toimitus on ilmainen. Lähetämme viimeistään seuraavana
									arkipäivänä.
								</p>
								<div className="mt-2">
									<Link href="/osta">
