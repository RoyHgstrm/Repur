...
export const metadata: Metadata = {
  ...
  description: "Ota yhteyttä Repur.fi-asiakaspalveluun sähköpostitse tai tutustu usein kysyttyihin kysymyksiin ja tukimateriaaleihin.",
};
  ...
  return (
    <div className="container mx-auto px-container py-section min-h-screen flex flex-col items-center justify-center">
      ...
      <header className="text-center mb-12">
        <h1 className="text-4xl-fluid font-bold text-text-primary mb-4">Yhteystiedot</h1>
        <p className="text-lg-fluid text-text-secondary max-w-2xl mx-auto">
          Olemme täällä auttaaksemme sinua! Voit ottaa meihin yhteyttä sähköpostitse.
        </p>
      </header>
      ...
      <Card className="w-full bg-surface-2 border-[var(--color-border-light)] shadow-lg rounded-xl p-4 sm:p-6 text-center">
        ...
        <Card className="w-full bg-surface-2 border-[var(--color-border-light)] shadow-lg rounded-xl p-4 sm:p-6">
          ...
          <CardContent className="p-0">
            <p className="text-sm sm:text-base-fluid text-text-secondary text-center sm:text-left">Tarvitsetko apua laitteesi kanssa tai onko sinulla kysyttävää takuusta?</p>
            <div className="mt-4 flex flex-col sm:flex-row flex-wrap items-center justify-center sm:justify-start gap-3">
              ...
              <Link href="/tuki" passHref><Button className="w-full sm:w-auto h-10 px-5">Tuki</Button></Link>
              <Link href="/takuu" passHref><Button variant="outline" className="w-full sm:w-auto h-10 px-5">Takuu</Button></Link>
            </div>
          </CardContent>
        </Card>
          ...
          <Card className="bg-gradient-to-br from-surface-2 to-surface-3 border-none shadow-xl rounded-2xl overflow-hidden">
            ...
            <CardContent className="p-6">
              ...
              <div className="mt-6 text-center">
                <Link href="/tuki/ukk" passHref><Button variant="outline" className="mt-4">Katso kaikki UKK</Button></Link>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-surface-2 to-surface-3 border-none shadow-xl rounded-2xl overflow-hidden">
            <CardHeader className="bg-surface-1/70 px-6 py-4 border-b border-[var(--color-border-light)]">
              <CardTitle className="text-lg font-semibold flex items-center gap-2">
                ...
                <span className="inline-block bg-[var(--color-primary)]/10 rounded-full p-2">
                  <svg className="h-5 w-5 text-[var(--color-primary)]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M17 2a2 2 0 00-2 2v2H9V4a2 2 0 00-2-2H4a2 2 0 00-2 2v16a2 2 0 002 2h3a2 2 0 002-2v-2h6v2a2 2 0 002 2h3a2 2 0 002-2V4a2 2 0 00-2-2h-3zM7 10h10M7 14h10" /></svg>
                </span>
                Seuraa meitä
              </CardTitle>
            </CardHeader>
            <CardContent className="p-6">
              <p className="text-base-fluid text-text-secondary">Pysy ajan tasalla uutisista, tarjouksista ja tapahtumista sosiaalisen median kanavissamme.</p>
              <div className="mt-4 flex flex-wrap gap-3">
                {/* Placeholder social media links - Replace with actual links and icons */} 
                <Button variant="outline" className="flex items-center gap-2">Facebook</Button>
                <Button variant="outline" className="flex items-center gap-2">Instagram</Button>
                <Button variant="outline" className="flex items-center gap-2">Twitter</Button>
              </div>
            </CardContent>
          </Card>
        </div>
