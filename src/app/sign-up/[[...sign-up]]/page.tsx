			...
			<SignUp
				appearance={{
					elements: {
						...
						formFieldInput:
							"bg-[var(--color-surface-3)] border-[var(--color-border)] text-[var(--color-neutral)] focus:ring-2 focus:ring-[var(--color-primary)]/40",
						socialButtonsBlockButton:
							"bg-[var(--color-surface-3)] hover:bg-[var(--color-surface-2)] text-[var(--color-neutral)]",
						footerActionLink:
