...
export default function CollapsibleComponent({ title, icon, children, defaultOpen = false }: CollapsibleComponentProps) {
      ...
      <CollapsibleTrigger asChild>
        <button
          className={cn(
            ...
            isOpen ? "bg-[var(--color-surface-3)] text-[var(--color-primary)]" : "text-[var(--color-neutral)]/80"
          )}
        >
